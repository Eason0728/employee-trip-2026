...
- 網址 `.../employee-trip-2026/guardian.html`；**未滿 18 歲者專用**（依出遊日 2026/9/14 計算，目前 6 位：林宸妤／王禹婕／徐佑昕＝小辛辣光復店、洪愷昱＝墨竹亭光復店、周冠銘＋林亞韻＝墨竹亭金山店；林亞韻原為周冠銘眷屬，2026-08-12 Eason 指定納入名單自行填報）。名單寫死在 `trip-data/build_guardian.py` 的 `MINORS`，**名單有變要手動改再重跑產生器**。
...
- 測試 `tests/test-guardian.js`（28 項）。其餘未成年眷屬（郭品暄/郭柏揚/張峮寧）的法代不另收——法代＝隨行員工本人。
